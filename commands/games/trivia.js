...
export async function execute(interaction) {
    try {
        // Si es el subcomando stats, mostrar estadísticas
        ...
        collector.on('end', async collected => {
            if (!answered) {
                ...
                const timeoutEmbed = embed
                    ...
                    .setTitle(`${EMOJIS.TIMER} ¡Tiempo Agotado!`)
                    .setDescription(`**Pregunta:** ${question.question}\n\n` +
                        `**Respuesta correcta:** ${question.correct_answer}`);
                ...
                // Actualizar estadísticas (pregunta fallada)
        ...
        await interaction.reply({
            content: `${EMOJIS.ERROR} Ocurrió un error al iniciar la ronda de trivia.`,
            ephemeral: true
        });
    }
} 